...
public class CustomerRepositoryImpl implements CustomerRepositoryCustom {
    ...
    // MIGRATION NOTE: Manual EntityManager retained in Phase 4 because customer criteria queries are not covered by active tests and a rewrite could alter current filtering or paging behavior.
    @PersistenceContext
