...
public class CategoryRepositoryImpl implements CategoryRepositoryCustom {
	...
	// MIGRATION NOTE: Manual EntityManager retained in Phase 4 because repository coverage is partial and rewriting these legacy JPQL methods could change current category query semantics.
	@PersistenceContext
