...
public class MerchantRepositoryImpl implements MerchantRepositoryCustom {
  ...
  // MIGRATION NOTE: Manual EntityManager retained in Phase 4 because the merchant criteria query has legacy paging/filter semantics without enough test coverage for a safe Spring Data replacement.
  @PersistenceContext
