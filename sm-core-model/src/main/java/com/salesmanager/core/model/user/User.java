...
public class User extends SalesManagerEntity<Long, User> implements Auditable {
	...
	// MIGRATION NOTE: Retain legacy Hibernate-specific cascade semantics during the Boot 4 / Hibernate 7 upgrade because removing LOCK/REPLICATE here could change persistence behavior on user-group associations.
